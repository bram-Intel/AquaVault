-- AquaVault Capital - Dynamic Investment System Update
...
-- Update investment_plans table to reference categories
ALTER TABLE `investment_plans` 
ADD COLUMN `category_id` int(11) DEFAULT NULL AFTER `id`,
ADD KEY `category_id` (`category_id`),
ADD FOREIGN KEY (`category_id`) REFERENCES `investment_categories` (`id`) ON DELETE SET NULL;

-- Update user_investments table to reference categories and durations
ALTER TABLE `user_investments` 
ADD COLUMN `category_id` int(11) DEFAULT NULL AFTER `plan_id`,
ADD COLUMN `duration_id` int(11) DEFAULT NULL AFTER `category_id`,
ADD KEY `category_id` (`category_id`),
ADD KEY `duration_id` (`duration_id`),
ADD FOREIGN KEY (`category_id`) REFERENCES `investment_categories` (`id`) ON DELETE SET NULL,
ADD FOREIGN KEY (`duration_id`) REFERENCES `investment_durations` (`id`) ON DELETE SET NULL;
