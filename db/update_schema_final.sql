-- AquaVault Capital - Dynamic Investment System Update (FINAL VERSION)
-- This script adds the new dynamic category and duration system
-- Run this AFTER importing the main schema.sql

-- Create investment_categories table (only if it doesn't exist)
...
-- Create investment_durations table (only if it doesn't exist)
